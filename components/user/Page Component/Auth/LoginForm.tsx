...
const LoginForm: React.FC = () => {
    ...
    return <View style={styles.formContainer}   >
        <View style={styles.titleContainer} >
            <Text style={styles.title} >Login to <Text style={{ color: primary, fontFamily: "Black" }} >{app_name}</Text></Text>
            <Text  >Enter your email or username and password to login.</Text>
        </View>
        {formStatus == "error" && <Text style={{ color: "#f44336" }} >{error}</Text>}
        <View style={styles.form} >
            <Input placeholder="Email or username" onChangeText={setEmail} />
            <View>
