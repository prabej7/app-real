...
const TabBar: React.FC<Props> = ({ state, descriptors, navigation }) => {
  ...
  const icons: Record<string, (props: IconProps) => JSX.Element> = {
    ...
    properties: (props) => <FontAwesome5 name="building" size={22} color={props.color} />,
    map: (props) => <Feather name="map" size={22} color={props.color} />,
    inbox: (props) => <Feather name="inbox" size={24} color={props.color} />,
    account: (props) => <Feather name="user" size={24} color={props.color} />,
  }
          ...
          >
            ...
            <Text
              style={[
                ...
                {
                  color: isFocused ? theme.primary : "rgba(128, 128, 128, 0.7)",
                  fontWeight: Platform.OS === "ios" && isFocused ? "500" : "400",
                },
              ]}
            >
              {label}
